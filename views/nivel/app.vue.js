...
Vue.component('AppVue', {
    ...
    methods: {
        ...
        reqLista() {
            this.sendData('/nivel/listaNivel', {}, res => {
        ...
        reqLanca() {
            this.sendData('/nivel/addNivelUsuario', this.payload(), res => {
        ...
        reqSave() {
            this.sendData('/nivel/save', this.payload(), res => {
                this.showToast(res.texto, 'success');
                this.reqLista();
            });
        },
        ...
        toolbarClick(args) {
            ...
            if (args.item.id === 'editar') {
                axios.post(BASE + "/nivel/loadData", { id: itemSelecionado.codigo })
                    .then(res => {
                        const d = res.data[0];
                ...
                axios.post(BASE + "/nivel/del", { id: itemSelecionado.codigo })
                    .then(res => {
